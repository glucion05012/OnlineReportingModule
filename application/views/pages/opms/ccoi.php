...
<div class="form-group-create">
    <form action="<?= base_url('ccoi'); ?>" method="post" accept-charset="utf-8">
        <div class="row">
        <div class="col-sm-12"><h1>CCOI</h1></div>
...
<table id="myTable" class="table table-responsive table-striped table-bordered table-sm" cellspacing="0" width="100%" >
    <thead>
        <tr>
            ...
            <th>Chemical Name</th>
            <th>CAS No.</th>
            <th>Quantity in Certificate (MT)</th>
            <th>Actual Quantity (MT)</th>
            <th>Region</th>
            <th>Province</th>
        ...
        if (isset($ccoi)) : ?>
            <?php foreach($ccoi as $app) : ?>
                ...
                <tr class="table-active"> 
                    ...
                    <td><?php echo $app['Chemical Group']; ?></td>
                    <td><?php echo $app['EMB Region']; ?></td>
                    <td><?php echo $app['Chemical Name']; ?></td>
                    <td><?php echo $app['CAS No.']; ?></td>
                    <td><?php echo $app['Quantity in Certificate (MT)']; ?></td>
                    <td><?php echo $app['Actual Quantity (MT)']; ?></td>
