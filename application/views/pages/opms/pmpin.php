...
<div class="form-group-create">
    <form action="<?= base_url('pmpin'); ?>" method="post" accept-charset="utf-8">
        <div class="row">
        <div class="col-sm-12"><h1>PMPIN</h1></div>
        ...
        if (isset($pmpin)) : ?>
            <?php foreach($pmpin as $app) : ?>
                ...
                <tr class="table-active"> 
                    ...
                    <td><?php echo $app['New/Amendment']; ?></td>
