...
<div class="form-group-create">
    <form action="<?= base_url('pto'); ?>" method="post" accept-charset="utf-8">
        <div class="row">
        <div class="col-sm-12"><h1>PTO</h1></div>
    ...
    <tbody>
        ...
        if (isset($pto)) : ?>
            <?php foreach($pto as $app) : ?>
                ...
                if ($app['Status'] == 'Pending (returned to applicant)'){
                    $pending = $pending + 1;
                }
                ...
                <tr class="table-active"> 
                    ...
                    <td><?php echo $app['Date Expired']; ?></td>
                    <td><?php echo $app['Region']; ?></td>
                    <td><?php echo $app['Name of Establishment']; ?></td>
                    <td><?php echo $app['ECC / CNC']; ?></td>
                    <td><?php echo $app['Office Address']; ?></td>
                    <td><?php echo $app['Province']; ?></td>
                    <td><?php echo $app['City/Municipality']; ?></td>
                    <td><?php echo $app['Barangay']; ?></td>
                    <td><?php echo $app['Name of Plant']; ?></td>
                    <td><?php echo $app['Plant Address']; ?></td>
                    <td><?php echo $app['Plant Geolocation']; ?></td>
                    <td><?php echo $app['Business Nature']; ?></td>
                    <td><?php echo $app['Date Operation Started']; ?></td>
                    <td><?php echo $app['Status']; ?></td>
                    <td><?php echo $app['PTO']; ?></td>
                    <td><button type="submit" class="btn btn-danger">Test</button></td>
                </tr>   
            <?php endforeach; ?>
