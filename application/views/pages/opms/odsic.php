...
<div class="form-group-create">
    <form action="<?= base_url('odsic'); ?>" method="post" accept-charset="utf-8">
        <div class="row">
        <div class="col-sm-12"><h1>ODS-IC</h1></div>
